...
class Dasar {
	public static void main(String[] args) {
		...
		*/
		...
		int contoh = 10;
		if (contoh < 10) System.out.println("Angka di bawah 10");
		else if (contoh == 10) System.out.println("Angka bukan di bawah 10, melainkan sama dengan 10");
		else System.out.println("Angka bukan di bawah 10 dan sama dengan 10 ataupun keduanya");
